...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((msg.sender == user1 || msg.sender == user2), "Sender is not owner of any of the stars");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender==ownerOf(_tokenId), "You cannot transfer a star that you do not own");
